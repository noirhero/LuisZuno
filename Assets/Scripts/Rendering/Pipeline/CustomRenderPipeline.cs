...
public class CustomRenderPipeline : RenderPipeline {
    ...
    private void PostProcessingRendering(ScriptableRenderContext context, Camera camera, PostProcessLayer ppLayer) {
        ...
        cmdBuf.GetTemporaryRT(_colorNameId, camera.pixelWidth, camera.pixelHeight, 0, FilterMode.Bilinear,
            RenderTextureFormat.ARGB32);
        cmdBuf.GetTemporaryRT(_depthNameId, camera.pixelWidth, camera.pixelHeight, 24, FilterMode.Point,
